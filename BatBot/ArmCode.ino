...
void startPosition() {
  goSmoothTo(RADIUS_START, HEIGHT_START, BASE_START, 500, 1);
}
...
void positionFor5(){
  goSmoothTo(21.4, 20, 90, 1000, 1);
  goSmoothTo(21.4, 34.4, 0, 1000, 1);
}

void store5(){
  goSmoothTo(21.4, 34.4, 90, 500, 1);
  goSmoothTo(16, 31, 90, 500, 1);
  goSmoothTo(9, 27, 37, 500, 1);
  goSmoothTo(9, 23.1, 37, 500, 1);
  goSmoothTo(9, 21.8, 37, 500, 1);
  goFast(9, 21.8, 180);
  startPosition();
}

void pickUpNum6(){
  goSmoothTo(20.7, 40.1, 90, 500, 1);
  goSmoothTo(35.3, 22, 87, 500, 1);
  goSmoothTo(35.3, 21.7, 90, 500, 1);
  goFastTo(35.3, 21.7, 60);
  goFastTo(35.3, 21.7, 120);
  goSmoothTo(35.3, 21.7, 60, 500, 1);
  goSmoothTo(32, 25, 90, 500, 1);
  goSmoothTo(29.6, 35.6, 90, 500, 1)
  goSmoothTo(17.4, 39.4, 90, 500, 1);
  goSmoothTo(13.9, 30.6, 134, 500, 1)
}

void dropOff6(){
  goSmoothTo(13.6, 34.4, 140, 500, 1);
  goFastTo(19.9, 34.4, 0);
  startPosition();
}

void pickUpNum3(){
  goSmoothTo(13.5, 34.4, 98, 500, 1);
  goSmoothTo(20.3, 25.6, 165, 500, 1);
  goSmoothTo(20.3, 22.7, 159, 500, 1);
  goSmoothTo(21.5, 19.3, 163, 500, 1);
  goSmoothTo(21.5, 34.4, 163, 500, 1);
  goSmoothTo(13.6, 34.4, 113, 500, 1);
  goFastTo(19.9, 34.4, 0);
  startPosition();
}

void pickUpNum2(){
  goSmoothTo(17.5, 32.5, 180, 500, 1);
  goSmoothTo(16.7, 21.1, 180, 500, 1);
  goSmoothTo(18, 23.2, 176, 500, 1);
  goSmoothTo(18, 18.3, 176, 500, 1);
  goSmoothTo(24.1, 18.3, 180, 500, 1);
  goSmoothTo(20, 18.3, 176, 500, 1);
  goSmoothTo(20, 29.3, 176, 500, 1);
  goSmoothTo(13.8, 35, 158, 500, 1);
  goSmoothTo(7.5, 35, 169, 500, 1);
  goSmoothTo(7.5, 25, 153, 500, 1);
  goSmoothTo(8, 25, 144, 500, 1);
  goSmoothTo(8, 20, 144, 500, 1);
  goFastTo(8, 20, 13);
  startPosition();
}
